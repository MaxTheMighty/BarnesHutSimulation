...
impl Rectangle {
    ...
    pub fn width(&self) -> body::Float {
        return self.br.x - self.tl.x;
    }

    pub fn height(&self) -> body::Float {
...
impl Quadtree {
    ...
    pub fn split(&mut self) {
        ...
        self.subtrees
            .push(Box::new(Quadtree::new(subranges.0, self.limit)));
        self.subtrees
            .push(Box::new(Quadtree::new(subranges.1, self.limit)));
        self.subtrees
            .push(Box::new(Quadtree::new(subranges.2, self.limit)));
        self.subtrees
            .push(Box::new(Quadtree::new(subranges.3, self.limit)));
    }
    ...
    pub fn calculate_center_leaf(&mut self) {
        ...
        for body in &self.bodies {
            ...
            //is this valid?
            self.center_of_mass = Some(self.center_between_two_points(
                self.center_of_mass.unwrap(),
                self.total_mass,
                body.pos,
                body.mass,
            ));
